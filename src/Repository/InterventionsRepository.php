...
class InterventionsRepository extends ServiceEntityRepository
{
    ...
    public function findPlanBySujet($sujet){
        return $this->createQueryBuilder('Interventions')
            ->andWhere('Interventions.id LIKE :sujet or Interventions.type_dentretient LIKE :sujet  or Interventions.etat Like :sujet')
